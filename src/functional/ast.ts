...
export type Lambda = { type: 'Lambda'; params: string[]; body: Expression };
...
export type Expression = NumberLiteral | BooleanLiteral | Identifier | Lambda | Call | Let | IfExpr | Pipe | Binary | Match | AwaitExpr | ReturnExpr | ClassDecl | NewInstance | PropAccess;
