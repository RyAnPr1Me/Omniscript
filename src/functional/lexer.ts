...
const KEYWORDS = new Set(['var','def','fn','true','false','if','then','else','match','object','class','operator','new','extends','try','catch','finally','return','throw','await','async','use','import','from','typeof','curry','lazy','memo']);
