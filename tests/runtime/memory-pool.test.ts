...
describe('Runtime - Memory Pool', () => {
  ...
  describe('Memory Pool Limits', () => {
    it('should throw error when pool is exhausted', () => {
      ...
      expect(() => pool.allocate()).toThrow('Memory pool exhausted: maximum size reached');
    });
  ...
  describe('Memory Pool Manager', () => {
    ...
    it('should clear all pools', () => {
      poolManager.createPool('pool1', { initialSize: 1, maxSize: 5, objectType: Object });
      poolManager.createPool('pool2', { initialSize: 1, maxSize: 5, objectType: Array });
  ...
  describe('Memory Pool Statistics', () => {
    it('should track allocation and release statistics', () => {
      ...
      const obj1 = pool.allocate();
      pool.allocate(); // obj2 allocated but not used in test
    ...
    it('should calculate utilization correctly', () => {
      ...
      pool.allocate(); // obj1 allocated but not used in test
      pool.allocate(); // obj2 allocated but not used in test
