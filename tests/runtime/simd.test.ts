...
describe("Runtime - SIMD Operations", () => {
  ...
  describe("Vector Operations", () => {
    ...
    it("should throw error for mismatched array lengths", () => {
      ...
      expect(() => runtime.simdAdd(a, b)).toThrow(
  ...
  describe("Matrix Operations", () => {
    ...
    it("should throw error for incompatible matrix dimensions", () => {
      ...
      expect(() => runtime.matrixMultiply(a, b)).toThrow(
  ...
  describe("SIMD Processor Direct Usage", () => {
    ...
    it("should validate input arrays", () => {
      expect(() => simdProcessor.add([], null as any)).toThrow(
        "Both arguments must be arrays",
      );
      expect(() => simdProcessor.add([1], "not an array" as any)).toThrow(
        "Both arguments must be arrays",
      );
    });
  });
