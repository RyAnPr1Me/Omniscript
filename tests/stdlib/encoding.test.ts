...
describe('Standard Library - Encoding', () => {
  ...
  test('error handling for invalid Base64', () => {
    expect(() => Encoding.fromBase64('invalid base64!')).toThrow('Base64 decoding failed');
  });

  test('error handling for invalid hex', () => {
    expect(() => Encoding.fromHex('invalid hex')).toThrow('Hex decoding failed');
  });

  test('error handling for invalid binary', () => {
    expect(() => Encoding.fromBinary('invalid binary')).toThrow('Binary decoding failed');
  });
  ...
  test('handles special HTML entities', () => {
    ...
    expect(encoded).toBe('&lt;div class=&quot;test&quot;&gt;Hello &amp; &quot;World&quot; &amp; &#39;Test&#39; &#x2F; End&lt;&#x2F;div&gt;');
