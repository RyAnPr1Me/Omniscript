...
import { 
  PatternMatcher, PatternBuilder, MatchCompiler, 
  Pattern, MatchCase 
...
describe('Advanced Pattern Matching', () => {
  ...
  test('matches constructor patterns', () => {
    ...
    const someValue = { constructor: { name: 'Some' }, __class: 'Some', field0: 42 };
  ...
  test('throws error for non-exhaustive patterns', () => {
    ...
    expect(() => matcher.match(99, cases)).toThrow('Non-exhaustive pattern match');
  });
});
